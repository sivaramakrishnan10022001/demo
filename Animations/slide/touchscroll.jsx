...
export const TouchScroll = ({ className }) => {
    const data = [
        {
            id: 1,
    ...
    useEffect(() => {
        const cardsContainer = document.querySelector(".touchscroll-card-carousel");
        class DraggingEvent {
        ...
        class CardCarousel extends DraggingEvent {
            ...
            calcScale(x) {
                ...
                const formula = 1 - 0.8 / 8 * Math.pow(x, 2)
            ...
            checkOrdering(card, x, xDist) {
                ...
                console.log("zIndex: temp", { zIndex: temp })
    ...
    return (
        <div className={`touchscroll-wapper ${className}`}>
            <div className='touchscroll-container'>
                <div className="touchscroll-card-carousel">
                    {
                        data.map((item, index) => {
                            return (
