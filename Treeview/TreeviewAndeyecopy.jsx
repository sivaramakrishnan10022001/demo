...
import "./TreeviewAndeyecopy.css";


export const TreeviewAndeyecopy = ({ data, eyeicon }) => {
    ...
    return (
        <div className='TreeviewAndeyecopy-wapper'>
            <div className="TreeviewAndeyecopy-container">
                        ...
                        datas.map((item, index) => {
                            return (
                                <>
                                    ...
                                    <div className={`TreeviewAndeye-vertical-container ${item.isOpen ? "open" : " close"}`}>
                                        {
                                            item.isOpen ?
                                                item.subtitleone ?
